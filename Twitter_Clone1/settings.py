...
SECRET_KEY = 'django-insecure-k$*qe*)0n1=ai&m_@a%slq-pehe+3d_$m3&1v4as(bsb+qb_7!'
...
cloudinary.config( 
  cloud_name = "dbju6nxn7", 
  api_key = "398951524626539", 
  api_secret = "iVtgIfwk9ZFU45G84PmluW7TZ6Q" 
)
